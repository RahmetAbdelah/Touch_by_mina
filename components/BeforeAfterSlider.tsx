      ...
      <ReactCompareSlider
        itemOne={
          <div className="relative">
            ...
            <span className="absolute bottom-3 left-3 bg-[#0d0c0b]/80 text-[#F5F5F5]/70 text-[10px] px-2 py-1 uppercase tracking-wider">
              {beforeLabel}
            </span>
          </div>
        }
        itemTwo={
          <div className="relative">
            ...
            <span className="absolute bottom-3 right-3 bg-[#0d0c0b]/80 text-brand-gold/80 text-[10px] px-2 py-1 uppercase tracking-wider">
              {afterLabel}
            </span>
          </div>
        }
          ...
          <ReactCompareSliderHandle>
            <div className="w-10 h-10 rounded-full bg-brand-gold/90 flex items-center justify-center shadow-lg shadow-black/30">
              <div className="flex gap-1">
                <ArrowLeft size={14} className="text-[#0d0c0b]" />
                <ArrowRight size={14} className="text-[#0d0c0b]" />
              </div>
            </div>
          </ReactCompareSliderHandle>
        }
